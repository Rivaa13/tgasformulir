...
<!-- Form penjumlahan -->
    <div class="container p-3 mt-5 border">
        <h2 class="text-center">FORM PENJUMLAHAN</h2>
            <form action="tugasformulir.php?action=penjumlahan" method="POST">
    <div class="mb-3">
   ...
   <!-- Form kelulusan -->
    <div class="container p-3 mt-5 border">
        ...
        <form action="tugasformulir.php?action=form" method="POST">
            <div class="mb-3">
    ...
    <div class="container p-3 mt-5 border">
        ...
        <form action="tugasformulir.php?action=kalkulator" method="POST">
            <div class="mb-3">
                <label for="angka1" class="form-label">Angka 1</label>
                <input type="number" class="form-control" placeholder="masukan angka1" name="angka1">
            </div>
